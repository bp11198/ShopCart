			...
			<div class="bag-item row ">
				...
				<div class="w-100 col">
					...
					<div class="d-flex" style="position: relative; padding-top: 25px;">
						...
						<form action="checkout.php" method="post" accept-charset="utf-8" style="margin: auto;">
							<input type="hidden" name="mgEdit" value="<?php echo $value->IDGiay ?>">
							X <input type="number" name="editSL" value="<?php echo $value->soLuong; ?>"> <span class="Sum-item">$<?php echo $tongtien; ?></span>
						</form>
...
<div class="footer">
	<div class="footer-top">
		<div class="wrap">
			...
			<div class="col_1_of_footer-top span_1_of_footer-top">
				<ul class="f_list">
					<li><img src="images/f_icon1.png" alt=""/><span class="delivery">Customer Service :<span class="orange"> (+84) 967830396(freephone)</span></span></li>
				</ul>
			</div>
			<div class="col_1_of_footer-top span_1_of_footer-top">
				<ul class="f_list">
	...
	<div class="copy">
		<div class="wrap">
			<p>© All rights reserved | Template by&nbsp;<a href="http://w3layouts.com/">BinhPhuong</a></p>
		</div>
	</div>
</div>
<script type="text/javascript">
